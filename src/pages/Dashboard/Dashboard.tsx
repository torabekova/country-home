...
<div >
  <Header/>
    ...
    >
      ...
      <div className="dflexdiv" style={{ display: "flex", justifyContent: "space-between", gap: "20px" }}>
      {statsData.map((item, index) => (
        <div key={index} className="treding" style={{ backgroundColor: "white", maxWidth: "237px", padding: "20px", borderRadius: "20px", paddingRight: "60px" }}>
          <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
            <div style={{ width: "40px", height: "40px", borderRadius: "100px", backgroundColor: item.bgColor, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "12px" }}>
              {item.icon}
            </div>
            <h5 style={{ fontFamily: "Manrope", fontSize: "20px", fontWeight: "600", lineHeight: "28px", textAlign: "center" }}>{item.title}</h5>
          </div>
          <h2 style={{ fontFamily: "Manrope", fontSize: "40px", fontWeight: "600", lineHeight: "48px", textAlign: "center" }}>{item.value}</h2>
        </div>
      ))}
    </div>
    ...
    >
      {["All", "5m", "1d", "1w", "1m", "1y"].map((label, index) => (
        <button
          key={index}
          style={{
            width: "49px",
